    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#020617] p-4">
        ...
        >
          ...
          <p className="text-slate-400 mb-8">Please sign in with your admin account to view submissions.</p>
          <button
            onClick={handleLogin}
            className="w-full py-4 bg-cyan-500 hover:bg-cyan-400 text-black font-bold rounded-xl transition-all flex items-center justify-center gap-2"
          >
            Sign in with Google
          </button>
          <button 
